                ...
                <div className={showIngredient ? "blur" : ""} >
                    <div className='headder-container'>
                        ...
                        <div className='category-button-container'>
                            ...
                            {mealType === "MAIN COURSE" ? <button className='category-button active' value="MAIN COURSE" onClick={onClickType}>Main Course {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "MAIN COURSE").length : 0}/{data.filter(item => item.mealType === "MAIN COURSE").length}</button>
                                : <button className='category-button' value="MAIN COURSE" onClick={onClickType}>Main Course {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "MAIN COURSE").length : 0}/{data.filter(item => item.mealType === "MAIN COURSE").length}</button>}
                            {mealType === "DESSERT" ? <button className='category-button active' value="DESSERT" onClick={onClickType}>Desert {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "DESSERT").length : 0}/{data.filter(item => item.mealType === "DESSERT").length}</button> :
                                <button className='category-button' value="DESSERT" onClick={onClickType}>Desert {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "DESSERT").length : 0}/{data.filter(item => item.mealType === "DESSERT").length}</button>}
                            {mealType === "SIDES" ? <button className='category-button active' value="SIDES" onClick={onClickType}>Sides {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "SIDES").length : 0}/{data.filter(item => item.mealType === "SIDES").length}</button> :
                                <button className='category-button' value="SIDES" onClick={onClickType}>Sides {selectItem.length > 0 ? selectItem.filter(item => item.mealType === "SIDES").length : 0}/{data.filter(item => item.mealType === "SIDES").length}</button>}
                    ...
                    <div className='content-container'>
                        {
                            filterList.length > 0
                                ...
                                : <h1 style={{ textAlign: "center", marginTop: "179px" }}> No Dish found</h1>
                        }
                    </div>
                </div>
            </div>
